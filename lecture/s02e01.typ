...
More than `min`, we can  imagine making the structure generic taking a custom function in parameter. The only real limitation to the operations we can use in a segment tree is that is shall be associative ($a times.o (b times.o c) = (a times.o b) times.o c$).
...
#align(center, diagram(
  ...
  edge(N, I, "-"),
  edge(A, B, "-", stroke: red),
  edge(A, H, "-", stroke: red, bend: 25deg),
