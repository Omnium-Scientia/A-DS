...
#align(center, diagram(
  ...
  node(H, $F(9)$),
  node(I, $F(8)$, stroke: blue, shape: shapes.pill),

  node(Q, $F(8)$, stroke: blue, shape: shapes.pill),
  node(R, $F(7)$, stroke: red, shape: shapes.pill),
  node(S, $F(7)$, stroke: red, shape: shapes.pill),
  node(T, $F(6)$),

  node(L, $F(7)$, stroke: red, shape: shapes.pill),
  node(M, $...$),
  node(O, $...$),
  node(P, $...$),
  node(U, $...$),
...
#align(
  ...
  diagram(
    ...
    edge(n8, (-2.25, 4.5), ".."),
    edge(n1, (-2.4, 4.5), bend: -30deg, stroke: red, text(fill: red)[$n$ elt]),
  ),
)
...
#align(
  ...
  diagram(
    ...
    node(n1, $"    "$, stroke: 1pt, shape: shapes.rect),
    node(n2, $"    "$, stroke: 1pt, shape: shapes.rect),

    edge(n0, n1, "->", bend: 40deg, label: $<=j$),
    edge(n1, n2, "->", bend: 40deg, label: $j<=k$),
  ),
)
