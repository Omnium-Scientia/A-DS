...
#align(center, diagram(
  ...
  edge(lbn, u1, stroke: red),
  edge(mb1, u2, stroke: red),
  edge(mb2, u3, stroke: red),
  edge(mu3, u4, stroke: red),
  edge(ul, mb1, stroke: red),
  edge(mb2, u1, stroke: red),
  edge(mb3, u2, stroke: red),
  edge(mu4, u3, stroke: red),

  edge(mu4, u5, stroke: blue),
  edge(mu5, u6, stroke: blue),
  edge(mu6, ur, stroke: blue),
  edge(mu5, u4, stroke: blue),
  edge(mu6, u5, stroke: blue),
  edge(run, u6, stroke: blue),

  edge(lbn, b1, stroke: blue),
  edge(mb1, b2, stroke: blue),
  edge(mb2, b3, stroke: blue),
  edge(mb1, bl, stroke: blue),
  edge(mb2, b1, stroke: blue),
  edge(mb3, b2, stroke: blue),
