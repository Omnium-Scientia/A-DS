...
#align(center, grid(
  ...
  diagram(
    ...
    node(a, "A", stroke: 1pt, shape: rect),
    node(b, "B", stroke: 1pt, shape: rect),
    node(c, "C", stroke: 1pt, shape: rect),
...
#align(center, grid(
  ...
  align(center + horizon, diagram(
    ...
    node(n0, text(fill: blue)[head]),
    node(n1, text(fill: blue)[tail]),
  )),
  align(horizon, grid(
    row-gutter: 25pt,
    [$"add(A)"$],
