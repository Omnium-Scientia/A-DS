...
#align(
  ...
  diagram(
    ...
    edge((0.2, 0.5), (0.8, 0.5), "|-|", label: text(8pt)[$w_0$], label-side: right),
    edge((1.1, 0.5), (2.1, 0.5), "|-|", label: text(8pt)[$w_1$], label-side: right),
    edge((2.4, 0.5), (2.6, 0.5), "|-|", label: text(8pt)[$w_2$], label-side: right),

    edge((0.2, 1.5), (1.2, 1.5), "|-|", label: text(8pt)[$w_3$], label-side: right),
    edge((1.5, 1.5), (2.4, 1.5), "|-|", label: text(8pt)[$w_4$], label-side: right),

    edge((0.2, 2.5), (1.2, 2.5), "|-|", label: text(8pt)[$w_5$], label-side: right),
    edge((1.5, 2.5), (2.7, 2.5), "<->", stroke: red),

    edge((0.2, 3.5), (2.2, 3.5), "|-|", label: text(8pt)[$w_6$], label-side: right),
    edge((2.4, 3.5), (2.6, 3.5), "|-|", label: text(8pt)[$w_7$], label-side: right),

    edge(c0, c1),
    edge(c0, c2),
    edge(c2, c3),
    edge(ll, lr, "<->", label: $L$, label-side: right),
  ),
)
...
#align(
  ...
  diagram(
    ...
    edge((0.2, 0.5), (0.8, 0.5), "|-|", label: text(8pt)[$w_0$], label-side: right),
    edge((1.1, 0.5), (2.1, 0.5), "|-|", label: text(8pt)[$w_1$], label-side: right),
    edge((2.4, 0.5), (2.8, 0.5), "<->", stroke: red),

    edge((0.2, 1.5), (0.6, 1.5), "|-|", label: text(8pt)[$w_2$], label-side: right),
    edge((1.2, 1.5), (2.2, 1.5), "|-|", label: text(8pt)[$w_3$], label-side: right),
    edge((2.4, 1.5), (2.8, 1.5), "<->", stroke: red),

    edge((1.5 - 1.3, 2.5), (2.4 - 1.3, 2.5), "|-|", label: text(8pt)[$w_4$], label-side: right),
    edge((1.3, 2.5), (2.3, 2.5), "|-|", label: text(8pt)[$w_5$], label-side: right),
    edge((2.4, 2.5), (2.8, 2.5), "<->", stroke: red),
