...
#align(center, diagram(
  ...
  node(a, $circle.filled$),
  node(b, $circle.filled$),
  node(c, $circle.filled$),
  node(d, $circle.filled$),
  node(e, $circle.filled$),
  node(f, $circle.filled$),
  node(g, $circle.filled$),
  node(h, $circle.filled$),
))
