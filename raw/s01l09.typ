...
#cite(label("ads-s1-e9"), form: none)
...
#align(center, diagram(
  ...
  node(n3, $6$),
  node(n4, $8$),
  edge(n1, n2, "-", text(fill: red)[$<=$], label-angle: -90deg),
  edge(n1, n3, "-", text(fill: red)[$<=$], label-angle: -45deg, label-pos: 0.8),
  edge(n3, n4, "-", text(fill: red)[$<=$], label-angle: -90deg),
  ...
  node(n7, $10$),
  node(n8, $25$),
  edge(n5, n6, "-", text(fill: red)[$<=$], label-angle: -90deg),
  edge(n5, n7, "-", text(fill: red)[$<=$], label-angle: -45deg),
  edge(n7, n8, "-", text(fill: red)[$<=$], label-angle: -90deg),
...
#align(center, diagram(
  ...
  node(n3, $$),
  node(n4, $$),
  edge(n1, n2, "->", stroke: red),
  edge(n3, n4, "->", stroke: red, bend: 30deg),
  edge(n3, n4, "->", stroke: red, bend: -30deg),
  ...
  node(n7, $$),
  node(n8, $$),
  edge(n5, n6, "->", stroke: red),
  edge(n5, n7, "->", stroke: red),
  edge(n7, n8, "->", stroke: red),
...
#align(center, diagram(
  ...
  node((2.5, 2.5), text(fill: blue)[$H_1$], stroke: 0pt),
  node((3.5, 2.5), text(fill: blue)[$H_2$], stroke: 0pt),
))
