...
#cite(label("ads-s1-e8"), form: none)
...
#grid(
  ...
  diagram(
    ...
    edge(n2, n1, "->"),
    edge(n3, n1, "->"),
    edge(n1, n1, "->", bend: 135deg, loop-angle: 120deg),
  ),
  diagram(
    node-stroke: 1pt,
...
#align(center, diagram(
  node((0, 0), $X$, stroke: 1pt),
  node((0, 1.5), $$, stroke: 1pt),
  edge((0, 0), (0, 1.5), "~"),
  edge((-1.5, 1.85), (1.5, 1.85)),
  edge((-1.5, 1.85), (0, -0.7), (1.5, 1.85)),
...
#align(center, diagram(
  ...
  node((-5, 0), $X$, stroke: 1pt),
  node((-5, 1.5), $$, stroke: 1pt),
  edge((-5, 0), (-5, 1.5), "~"),
  edge((-1.5 - 5, 1.85), (1.5 - 5, 1.85)),
  edge((-1.5 - 5, 1.85), (0 - 5, -0.7), (1.5 - 5, 1.85)),
...
#align(center, diagram(
  ...
  node(n3, $$),
  node(n4, $Y$),
  edge(n4, n1, "->", bend: 40deg),
  edge(n3, n1, "->", bend: 40deg),
  edge(n2, n1, "->"),
  edge(n1, n1, "->", bend: 135deg, loop-angle: 120deg),
...
#align(center, diagram(
  ...
  edge(n4, n3, "->"),
  edge(n3, n2, "->"),
  edge(n2, n1, "->", stroke: blue),
  edge(n1, n1, "->", bend: 135deg, loop-angle: 120deg),

  edge((5, 0.8), n6, "->"),
  node((5, 0.8), [find], stroke: 0pt),
))
