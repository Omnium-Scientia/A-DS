...
#cite(label("ads-s1-e13"), form: none)
...
#align(
  ...
  diagram(
    ...
    node(n0, $$),
    node(n1, $$),
    node(n2, text(fill: red)[$S$], stroke: red),
    node(n3, $$),
    node(n4, $$),
    node(n5, $$),
    node(n6, $$),
    ...
    edge(n0, n2, label: $4$, label-side: left),
    edge(n0, n3, label: $2$, label-side: right),
    edge(n0, n4, label: $2$, label-side: left),
    edge(n0, n5, label: $3$, label-side: right),
    edge(n1, n2, label: $7$),
    edge(n1, n5, label: $5$, label-side: right),
    edge(n1, n7, label: $6$, label-side: left),
    edge(n2, n3, label: $3$, label-side: right),
    edge(n3, n4, label: $5$, label-side: right),
    edge(n4, n5, label: $3$, label-side: right),
    edge(n4, n6, label: $8$, label-side: right),
    edge(n5, n7, label: $7$, label-side: right),
    edge(n6, n7, label: $5$, label-side: right),
  ),
)
...
#align(
  ...
  diagram(
    ...
    edge(n0, n2, label: $4$, label-side: left),
    edge(n0, n3, "<-", stroke: green, label: $2$, label-side: right),
    edge(n0, n4, "->", stroke: green, label: $2$, label-side: left),
    edge(n0, n5, label: $3$, label-side: right),
    edge(n1, n2, label: $7$),
    edge(n1, n5, "<-", stroke: green, label: $5$, label-side: right),
    edge(n1, n7, "->", stroke: green, label: $6$, label-side: left),
    edge(n2, n3, "->", label: $3$, label-side: right, stroke: green),
    edge(n3, n4, label: $5$, label-side: right),
    edge(n4, n5, "->", stroke: green, label: $3$, label-side: right),
    edge(n4, n6, label: $8$),
    edge(n5, n7, label: $7$, label-side: right),
    edge(n6, n7, "<-", stroke: green, label: $5$, label-side: right),
  ),
)
...
#align(
  ...
  diagram(
    ...
    edge((2, 0), (2, 1), stroke: blue),
    edge((2, 1.5), (2, 2.5), stroke: blue),
    edge((2.5, 0), (2.5, 1.5), stroke: blue),
    edge((2.5, 2.5), (2.5, 3), stroke: blue),
    edge((3, 1.5), (3, 2.5), stroke: blue),

    edge((0.5, 0.5), (1.5, 0.5), stroke: blue),
    edge((2.5, 0.5), (3.5, 0.5), stroke: blue),
    edge((0, 1), (0.5, 1), stroke: blue),
    edge((1.5, 1), (3.5, 1), stroke: blue),
    edge((0.5, 1.5), (3.5, 1.5), stroke: blue),
    edge((0, 2), (1.5, 2), stroke: blue),
    edge((2, 2), (3, 2), stroke: blue),
...
#align(
  ...
  diagram(
    ...
    edge(c0, c1, stroke: green),
    edge(c0, c2, stroke: green),
    edge(c1, c3, stroke: green),
    edge(c2, c3, stroke: green),
    ...
    let (c0, c1, c2, c3) = ((ox, oy), (x, oy), (ox, y), (x, y)),
    edge(c0, c1, stroke: red),
    edge(c0, c2, stroke: red),
    edge(c1, c3, stroke: red),
    edge(c2, c3, stroke: red),
    ...
    node((0.25, -0.3), text(8pt)[$0$]),
    node((3.25, -0.3), text(8pt)[$i-1$]),
  ),
)
...
$
  D[i,j,p] eq.def & "number of way to fill the first" i "columns" \
                  & + j "squares with profile" p
$
...
#align(
  ...
  diagram(
    ...
    node((0.25, -0.3), text(8pt)[$0$]),
    node((3.25, -0.3), text(8pt)[$i$]),
    node((-0.3, 1.25), text(8pt)[$j$]),
  ),
)
...
#align(
  ...
  diagram(
    ...
    edge((2.75, 3.5), (2.75, 3.1), "->", stroke: black),
    node((2.75, 3.6), $p$),
  ),
)
