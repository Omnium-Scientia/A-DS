...
#cite(label("ads-s1-e7"), form: none)
...
#align(center, diagram(
  ...
  edge(c1, c2, stroke: blue),
  edge(c2, c4, stroke: blue),
  edge(c4, c3, stroke: blue),
  edge(c3, c1, stroke: blue),
...
#align(center, diagram(
  ...
  edge(c1, c2, stroke: red),
  edge(c2, c4, stroke: red),
  edge(c4, c3, stroke: red),
  edge(c3, c1, stroke: red),
...
#align(center, diagram(
  ...
  edge(v1, v2, "->", [push(E)]),
  edge(v2, v3, "->", [pop()]),
  edge(v2, v4, "->", [push(F)], label-side: right),
))
...
#align(center, diagram(
  ...
  node(v3, "v.3"),
  edge(v1, v2, "->", [add(E)]),
  edge(v1, v3, "->", [add(F)], label-side: right),
))
...
- One of the easiest is to build queue on top of stacks. In the previous lecture, we talk about making queue out of 2 stacks @2-stack.
  ...
  #align(center, diagram(
    ...
    edge(v0, v1, "->"),
    edge(v1, v2, "->", [long operation]),
    edge(v1, v3, "->", [long operation], label-side: right),
...
#align(center, diagram(
  ...
  node(n1, $X$),
  node(n2, $Z$),
  node(n3, text(fill: red)[$Y$]),
  node(n4, text(fill: red)[$X'$]),
  node(n5, text(fill: red)[$Z'$]),
